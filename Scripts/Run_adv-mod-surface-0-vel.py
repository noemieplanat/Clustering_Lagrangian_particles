...
def Modified_AdvectionRK4_3D(particle, fieldset, time):
    ...
    depmin = 0.1 # Try limiting the depth at 0.1 (positive/negative values of velocity at the surface are only due to P/E). 0.494025 premier point de deptht
...
i_file = 300
fname = '/storage/nplanat/Glorys12_OP_journalier/ADV_j_%i_' %i_file +'.nc'
