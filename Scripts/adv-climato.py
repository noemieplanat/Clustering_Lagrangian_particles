...
################# Paths
folder_files = '/storage/nplanat/Glorys12_ORCA_climato/'
...
# ----  Getting paths
# ----  Getting paths
filesU = [name for name in  sort_file_liste(glob.glob('/storage/nplanat/Glorys12_ORCA_climato/LT_gridU*')) if name[-3:]!='tmp']
filesV = [name for name in  sort_file_liste(glob.glob('/storage/nplanat/Glorys12_ORCA_climato/LT_gridV*')) if name[-3:]!='tmp']
filesW = [name for name in sort_file_liste(glob.glob('/storage/nplanat/Glorys12_ORCA_climato/LT_gridW*')) if name[-3:]!='tmp']
filesT = [name for name in sort_file_liste(glob.glob('/storage/nplanat/Glorys12_ORCA_climato/LT_gridT*')) if name[-3:]!='tmp']
filesS = [name for name in  sort_file_liste(glob.glob('/storage/nplanat/Glorys12_ORCA_climato/LT_gridS*')) if name[-3:]!='tmp']
...
i_file = 200
fname = '/storage/nplanat/Glorys12_OP_journalier/ADV_c_%i_' %i_file 
